      ...
      i++;  
       ...
       if(ch==0)
       {
          for(int a=0;a<3;a++)
          {
            ...
            Rsen_arr[number] = (Rref1)*(vout1_ramp[a]/(vout2_ramp[a]-vout1_ramp[a]));
       ...
       if(ch==1)
       {
          for(int a=0;a<3;a++)
          {
            ...
            Serial.println(curr,4);
            //Rsen_arr[number]= (1E3*vout1_ramp[a])/curr;
            Rsen_arr[number] = (Rref2)*(vout1_ramp[a]/(vout2_ramp[a]-vout1_ramp[a]));
            //Serial.print(Rsen_arr[number]);
            sum+=Rsen_arr[number];
            number++;
       ...
       if(ch==2)
       {
        ...
        for(int a=0;a<3;a++)
        {
          ...
          Serial.println(curr,4);
          //Rsen_arr[number]= (1E3*vout1_ramp[a])/curr;
          Rsen_arr[number] = (Rref3)*(vout1_ramp[a]/(vout2_ramp[a]-vout1_ramp[a]));
          //Serial.print(Rsen_arr[number]);
          sum+=Rsen_arr[number];
          number++;
        }

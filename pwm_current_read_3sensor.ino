   ...
   for(int ch=0;ch<3;ch++)
   {
      ...
      i++;
       ...
       if(ch==0)
       {
          ...
          for(int a=0;a<5;a++)
          {
            float curr = ((vout2_ramp[a]-vout1_ramp[a])/(Rref1*10E3)) + c_t*((vout2_ramp[a+1]-vout1_ramp[a+1])-(vout2_ramp[a]-vout1_ramp[a]));
            curr = curr*10E6;
